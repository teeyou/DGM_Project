...
public class BiyomonEffect : Effect
{
    ...
    public override void PlaySkill()
    {
        ...
        GameObject go = EffectManager.Instance.PlaySkill(name, pos, rot);
        go.transform.GetChild(0).transform.localEulerAngles = new Vector3(0f, 0f, -transform.eulerAngles.y);
